 ...
 */
var EmerService;
EmerService = function(opts) {
  var options = {
    // 资源类型
    resourceKeys: [
      'RescueTeam※03',
      'Expert※01', 'Shelter※01', 'ANJIAN_DANGER※01',
      'ANJIAN_REPERTORY※01',
      'JC_WARBASE※01'
    ]
  };
  this.opts = jQuery.extend(true, options, opts);
  this.commonService = G.common.CommonService.getInstance(opts);
};
...
/**
   ...
   * @param ctx
   */
EmerService.prototype.getStatistics = function(callback, ctx) {
...
/**
   ...
   * @param ctx
   */
EmerService.prototype.getStatisticsByFilter = function(opts, callback, ctx) {
  var filter = {};
  opts = opts || {};
...
/**
   ...
   * @param ctx
   */
EmerService.prototype.getDataList = function(opts, callback, ctx) {
  opts = opts || {};
  opts.flatTag = true;
...
EmerService.prototype.getNearbyList = function(opts, callback, ctx) {
  opts = opts || {};
  opts.flatTag = true;
...
window.G.common.EmerService = EmerService;
