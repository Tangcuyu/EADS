 ...
 */
define(['common_service'], function (CommonService) {
  var Service = function (opts) {
    var options = {
      ...
      resourceKeys: [
          ...
          'BAS_COALMINE※01',
          'ANJIAN_TAILINGPOND※01',
          'ANJIAN_FIREWORKENT※1',
          'BAS_GEOLOGICHAZARD※01','ANJIAN_DANGER※01'
      ]
    }
    this.opts = jQuery.extend(true, options, opts);
    this.commonService = CommonService.getInstance(opts);
  }
